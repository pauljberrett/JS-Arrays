...
f = first(arr);
console.log("\n1. The array you are going to pass is ["+arr+"] and the first element returned is "+f);
...
l = last(arr);
console.log("\n2. The array you created is ["+arr+"] and the last element returned is "+l);

//---------------------------------------------------------------------------------------------------------------------------------------------------

var family = ['Tyler', 'Jordyn', 'Ryan', 'Chelsey', 'Ireland'];
//Create a function named 'looper' that is given family as it's only argument, loops through the given array, and alerts every item in the array.
console.log("\n3. Print every member of array which is ["+family+"]");
  //Code Here
...
console.log("\n4. Reverse prints our the array ["+letters+"]");
...
console.log("\n5. removes odd numbers in array ["+nums+"]");
...
function divider(nums, evens, odds){
  ...
  result = [evens, odds];
  console.log("\n6. Three arrays \nnums=["+nums+"] \nevens=["+evens+"] \nodds=["+odds+"] \nand your result should be ["+result+"]");
}
...
function finder(numbers, getRandomArbitrary){
...
console.log("\n7. found: "+finder(numbers, getRandomArbitrary));
...
console.log("str ='"+ str + "' reverse ='" + reverse(str) + "'");
...
console.log("\n8. Remove chips [" + myGroceryList+"]");
addItem(myGroceryList, 'Jerky'); //--> ['pizza', 'hotpockets', 'MtnDew', 'corndogs', 'Jerky'];
console.log("add Jerky [" + myGroceryList+"]");
...
console.log("\n11.a the larger array is " + larger(arr1,arr2));
...
function hire(employee){
  for(i=0;i<devMountainEmployees.length;i++){
    if(employee.name === devMountainEmployees[i].name){
      return;
    }
  }
